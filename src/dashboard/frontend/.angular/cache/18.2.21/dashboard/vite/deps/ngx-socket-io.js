...
var require_socket3 = __commonJS({
  "node_modules/socket.io-client/lib/socket.js"(exports, module) {
    ...
    Socket.prototype.subEvents = function() {
      if (this.subs) return;
      var io2 = this.io;
      this.subs = [on(io2, "open", bind(this, "onopen")), on(io2, "packet", bind(this, "onpacket")), on(io2, "close", bind(this, "onclose"))];
    };
...
var WrappedSocket = class {
  constructor(config) {
    ...
    const ioFunc = import_socket.default ? import_socket.default : io;
